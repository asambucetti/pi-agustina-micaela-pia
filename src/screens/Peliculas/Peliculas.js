  ...
  return (
   <div class="container">
        ...
        <section class="row cards all-movies" id="movies">
            ...
            <article class="single-card-movie">
                <img src="https://image.tmdb.org/t/p/w500/9PXZIUsSDh4alB80jheWX4fhZmy.jpg" class="card-img-top" alt="..."/>
                <div class="cardBody">
            ...
            <article class="single-card-movie">
                <img src="https://image.tmdb.org/t/p/w500/A06yXys3hrCWu8xiNoHCFLTG5SH.jpg" class="card-img-top" alt="..."/>
                <div class="cardBody">
